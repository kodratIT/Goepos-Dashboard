        ...
        <form wire:submit.prevent="saveBankAccount">
            ...
            <div class="flex flex-col items-end mt-10">
                <button type="submit"
                    ...
                    <svg wire:loading wire:target="saveBankAccount" aria-hidden="true" role="status" class="inline w-4 h-4 me-3 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
