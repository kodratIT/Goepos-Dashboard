                            ...
                            @foreach ($paymentMethod as $payment)
                                @if($payment->active)
                                    ...
                                    @endif
                                        <td class="px-6 whitespace-nowrap">
                                            @if (isset($data->qris))
                                                <a wire:click.prevent="disabled" class="font-medium text-blue-600 dark:text-blue-500 hover:underline p-2">Disabled</a>
                                            ...
                                            @else
                                                <button type="button" id="activate-button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center" style="margin-right: 20px;">Activate</button>

                                                <button type="button" id="confirm-activate"
                                                        class="hidden text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center"
